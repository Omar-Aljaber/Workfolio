<x-app-layout>
    ...
    <div class="row justify-content-center">
        <div class="col-10 col-xl-7 card p-5 mt-5">
            ...
            <form action="/public/project/create" method="POST">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="summary" class="form-label">{{__('Project Summary')}}</label>
                ...
                <div class="mt-5">
                    <button type="submit" class="btn btn-primary px-4 px-sm-5">{{__('Create')}}</button>
                    <a href="/public/projects" class="btn btn-warning px-4 px-sm-5">{{__('Cancel')}}</a>
                </div>
            </form>
        </div>
    </div>
